  ...
  return (
    <div className="card">
		<div className="card__info">
			...
			<p className="card__info__time">{currentClock?.hour}h{currentClock?.minute}</p>
			<p className="card__info__date">{currentClock?.month} {currentClock?.day}, {currentClock?.year}</p>
		</div>
		<div className="card__weather">
			...
			<p className="card__weather__temp">  18° C</p>
		</div>
	</div>
  )
}
